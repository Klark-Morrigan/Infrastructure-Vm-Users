...
# -----------------------------------------------------------------------
# 4. Install Common.PowerShell and Infrastructure.HyperV
...
Write-Step 4 'installing Common.PowerShell from PSGallery'

# Inline retry for the chicken-and-egg case: Invoke-ModuleInstall (which
# has retry built in) ships inside Common.PowerShell, so it cannot be
